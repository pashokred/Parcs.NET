Function Create-VMConfig
{
	...
	New-AzureRmVMConfig -VMName $VMName -VMSize Standard_D2s_v3 | `
...
New-AzureRmResourceGroup -Name ParcsResourceGroup -Location qatarcentral

# Create a subnet configuration
$subnetConfig = New-AzureRmVirtualNetworkSubnetConfig -Name mySubnet -AddressPrefix 192.168.1.0/24

# Create a virtual network
$vnet = New-AzureRmVirtualNetwork -ResourceGroupName ParcsResourceGroup -Location qatarcentral `
-Name MYvNET -AddressPrefix 192.168.0.0/16 -Subnet $subnetConfig

# Create a public IP address and specify a DNS name
$pip = New-AzureRmPublicIpAddress -ResourceGroupName ParcsResourceGroup -Location qatarcentral `
...
$nsg = New-AzureRmNetworkSecurityGroup -ResourceGroupName ParcsResourceGroup -Location qatarcentral `
...
$nic = New-AzureRmNetworkInterface -Name myNic -ResourceGroupName ParcsResourceGroup -Location qatarcentral `
...
New-AzureRmVM -ResourceGroupName ParcsResourceGroup -Location qatarcentral -VM $vmConfig
